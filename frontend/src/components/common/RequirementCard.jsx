                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {showRateButton && (
                    <button 
                      ...
                      className="group flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-semibold text-yellow-600 hover:text-yellow-700 hover:bg-yellow-50 rounded-lg transition-all duration-200 border border-yellow-200 hover:border-yellow-300"
                    >
                      <svg className="w-3 h-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
