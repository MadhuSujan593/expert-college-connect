       ...
       {hasMore && (
         <div className="flex justify-center py-8">
           <button
             ...
             className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
           >
             {isLoadingMore ? (
               ...
               `Load More Opportunities (${totalRequirements - requirements.length} remaining)`
             )}
           </button>
         </div>
       )}
