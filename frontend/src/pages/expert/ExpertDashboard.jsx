    ...
    const handlePaymentCallback = async () => {
      ...
      if (paymentStatus && orderId) {
        ...
        try {
          ...
          const verifyResponse = await fetch(`${api.baseURL}/subscriptions/verify-order?orderId=${orderId}`, {
          ...
          if (orderData.order_status && ['PAID', 'SUCCESS'].includes(orderData.order_status.toUpperCase())) {
            ...
            const confirmationResult = await api.confirmRazorpayPayment(planId, payload, billingPeriod);
            ...
            setToast({
              show: true,
              message: `Payment status: ${orderData.order_status}. Please contact support if payment was successful.`,
              type: 'warning'
            });
