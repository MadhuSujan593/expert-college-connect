...
const CollegeDashboard = () => {
  return (
    <div className="max-w-4xl mx-auto py-16 px-4">
      <h1 className="text-3xl font-heading font-bold mb-4 text-center">College Dashboard</h1>
      <p className="text-secondary-600 mb-8 text-center">
        Welcome to your dashboard! Here you can manage your institution profile, post requirements, and connect with experts.
      </p>
